...
|ID|Benutzername|Voller Name|Rollen|Team|
|--|------------|-----------|------|----|
|1 |adradm00    |Adrian Admin|ADMIN| -  |
|2 |maxmus00    |Max Muster|USER| 1 |
|3 |annmus00    |Annika Muster|USER| 1 |
|4 |larlea00	|Lara Leader|TEAMLEADER| 1 |
|5 |manmer00    |Manfred Meerfeld|USER| 2 |
|6 |gudgan00    |Gudrun Gans|USER| 2 |
|7 |leolea00    |Leon Leader|TEAMLEADER| 2 |